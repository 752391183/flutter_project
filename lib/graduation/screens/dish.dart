...
class DishListState extends State<DishList> {
  ...
  @override
  Widget build(BuildContext context) {
    dish = Provider.of<CartlogModel>(context);
            ...
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  ...
                  onTap: (){
                    dish.addCurrentDish(dish.listDishes()[index]);
...
class CurrentTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // TODO: implement build
    return Consumer<MyTableModel>(builder: (context, table, widght){
...
class DishModal extends StatelessWidget{
  ...
  @override
  Widget build(BuildContext context) {
    tableModel = Provider.of<MyTableModel>(context);
    // TODO: implement build
    return Container(
      height: 300,
      child: Column(
